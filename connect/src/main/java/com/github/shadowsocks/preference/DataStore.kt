...
object DataStore : OnPreferenceDataStoreChangeListener {
    ...
    var falconExpandList: String
        get() = privateStore.getString("expand") ?: ""
        set(value) = privateStore.putString("expand", value)

    var falconStorageLanguage: String //当前的语言
        get() = privateStore.getString("language") ?: "en"
        set(value) = privateStore.putString("language", value)

    var falconStorageAutomatic: Boolean
        get() = privateStore.getBoolean("automatic") ?: false
        set(value) = privateStore.putBoolean("automatic", value)

    var falconStorageVPN: String
        get() = privateStore.getString("vpn") ?: ""
        set(value) = privateStore.putString("vpn", value)
}
